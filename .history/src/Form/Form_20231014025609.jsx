  ...
  return (
    <form action="submit" className="form" onSubmit={(e) => e.preventDefault()}>
      <div className="input-enclose">
       {fNameEmpty && <img src={errorIcon} alt="error-icon" className="error-icon" />}
        <input
          type="text"
      ...
      <div className="input-enclose">
        {lNameEmpty && <img src={errorIcon} alt="error-icon" className="error-icon" />}                               
        <input
          type="text"
      ...
      <div className="input-enclose">
        {passEmpty && <img src={errorIcon} alt="error-icon" className="error-icon" />}
        <input
          type="password"
