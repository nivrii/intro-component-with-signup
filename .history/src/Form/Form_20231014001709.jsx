  ...
  return (
    <form action="submit" className="form" onSubmit={handleSubmit}>
      ...
      <div className="input-enclose">
        ...
        />
        <div className="err-enclose">
          {lNameEmpty && <div className="open err err-lName">Last Name Cannot Be Empty</div>}
        </div>
      </div>
      ...
      <div className="input-enclose">
        ...
        />
        <div className="err-enclose">
          {emailEmpty && <div className="open  err err-email">Email Cannot Be Empty</div>}
      ...
      <div className="input-enclose">
        ...
        />
        <div className="err-enclose">
          {passEmpty && <div className="open  err err-password">Password Cannot Be Empty</div>}
        </div>
      </div>
