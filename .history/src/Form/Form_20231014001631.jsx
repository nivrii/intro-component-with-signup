  ...
  return (
    <form action="submit" className="form" onSubmit={handleSubmit}>
      ...
      <div className="input-enclose">
        ...
        />
        <div className="err-enclose">
          {lNameEmpty && <div className="err err-lName">Last Name Cannot Be Empty</div>}
        </div>
      </div>
      ...
      <div className="input-enclose">
        ...
        />
        <div className="err-enclose">
          {emailEmpty && <div className=" err err-email">Email Cannot Be Empty</div>}
      ...
      <div className="input-enclose">
        ...
        />
        <div className="err-enclose">
          {passEmpty && <div className=" err err-password">Password Cannot Be Empty</div>}
        </div>
      </div>
