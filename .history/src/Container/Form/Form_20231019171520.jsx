...
export function Form({ userArray, setUserArray }) {
  ...
  const emailMatcher = (email) => {
    ...
    if (!email.match(regex)) {
      document.querySelector(".email-input").classList.add("input-error");
      document.querySelector(".err-email").classList.remove("close");
      document.querySelector(".err-email").classList.add("err");
      setEmailPass(false);
      return;
    } else {
      setEmailPass(true);
      document.querySelector(".err-email").classList.add("close");
      document.querySelector(".err-email").classList.remove("err");
    }
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (email === "") {
      setEmailEmpty(true);
      document.querySelector(".email-input").classList.add("input-error");
      let divv = document.querySelector(".err-email").classList.add("err")
      divv.textContent = "Email Cannot Be Empty"
    ...
    <>
      ...
      >
        ...
        <div className="input-enclose">
          ...
          />
          <div className="err-enclose">
              <div className="close err-email"></div>
          </div>
        </div>
